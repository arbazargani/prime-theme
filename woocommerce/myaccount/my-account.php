    ...
    <div id="main-wrapper" class="wrapper">
        <div class="profile-wrapper">
            <div class="profile-right-wrapper">
                ...
                <ul>
                        <div class="profile-nav-top">
                            <li>
                                <a style="font-weight: bold" href="<?php echo home_url(); ?>/my-account/edit-address/صورت-حساب">
                                    اطلاعات کاربر
                                </a>
                            </li>
                            <li>
            ...
            <div class="profile-left-wrapper">
                <div class="form-row">
                <p>برای ویرایش اطلاعات <a href="edit-address/صورت-حساب">کلیک کنید.</a></p>
                </div>
                    <div class="form-row-double">
                        <div class="form-row">
                            ...
                            <input type="text" name="billing_first_name" id="billing_first_name" value="<?php echo $customer->get_billing_first_name(); ?>" disabled>
                        </div>
                        <div class="form-row">
                            <label for="billing_first_name">
                                نام خانوادگی
                            </label>
                            <input type="text" name="billing_first_name" id="billing_last_name" value="<?php echo $customer->get_billing_last_name(); ?>" disabled>
                        </div>
                    </div>
                    <div class="form-row-double">
                        <div class="form-row">
                            ...
                            <input type="text" name="billing_phone" id="billing_phone" autocomplete="tel" value="<?php echo wp_get_current_user()->user_phone; ?>" disabled>
                        </div>
                        <div class="form-row">
                            <label for="billing-email">
                                ایمیل
                            </label>
                            <input type="text" name="billing_email" id="billing_email" autocomplete="email username" value="<?php echo wp_get_current_user()->user_email; ?>" disabled>
                        </div>
                    </div>
                    <div class="form-row-double">
                        <div class="form-row">
                            ...
                            <select name="billing_state" id="billing_state" onChange="irancitylist(this.value);" disabled>
                        ...
                        <div class="form-row">
                            ...
                            <select name="billing_city" id="billing_city" disabled>
                                <option value="0">لطفا استان را انتخاب نمایید</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <input type="text" name="billing_postcode" id="billing_postcode" value="<?php echo $customer->get_billing_postcode(); ?>" autocomplete="postal-code" disabled>
                    </div>
                    <div class="form-row">
                        <label>
                            آدرس:
                        </label>
                        <textarea rows="5" cols="1" name="billing_address_1" id="billing_address_1" autocomplete="address-line1" disabled><?php echo $customer->get_billing_address_1(); ?></textarea>
                    </div>
                    <div class="form-btn-row">
                        <div class="profile-form-btn">
                            <button type="submit" class="button" style="
                                ...
                                cursor: pointer;
                                " name="save_address" value="ذخیره آدرس" disabled>ویرایش اطلاعات</button>
                        </div>
                        <div class="profile-form-btn-alt">
                            <button style="
                                ...
                                border: none;
                                background: none;
                                border-radius: 25px;" type="reset" disabled>انصراف</button>
                        </div>
                    </div>
                </div>
                <?php //wp_nonce_field( 'woocommerce-edit_address' ); ?>
                <?php wp_nonce_field( 'woocommerce-edit_address', 'woocommerce-edit-address-nonce' ); ?>
                <input type="hidden" name="_wp_http_referer" value="<?php echo get_site_url(); ?>/my-account/edit-address/صورت-حساب/">
